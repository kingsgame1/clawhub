...
## Two Modes
**Simple**, Use Case=Regular dynamic sites, Speed=Fast (3-5s), Anti-Bot=None
**Stealth** ⭐, Use Case=Sites with anti-bot, Speed=Medium (5-20s), Anti-Bot=Medium-High
...
**Anti-Bot Techniques:**
- Hide `navigator.webdriver`, Realistic User-Agent (iPhone), Human-like behavior simulation
...
## Test Results
**Discuss.com.hk**, Result= 200 OK, Time=5-20s
**Example.com**, Result= 200 OK, Time=3-5s
**Cloudflare Protected**, Result= Mostly successful, Time=10-30s
...
## Links
- [Playwright Official Docs](https://playwright.dev/), [Full Documentation (SKILL.md)](SKILL.md), [Installation Guide (INSTALL.md)](INSTALL.md), [Examples (examples/)](examples/)