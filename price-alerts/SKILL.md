...
| 市场 | API | 备注 |
|------|-----|------|
| 加密货币 | CoinGecko | 免费，无 API Key |
| 加密货币 | Binance | 基础行情免费 |
| 股票 | Alpha Vantage | 免费额度 500 次/天 |
| 外汇 | Open Exchange Rates | 免费额度 1000 次/月 |
...
- CoinGecko API: `references/coingecko_api.md`
- Binance API: `references/binance_api.md`
- 回测方法论: `references/backtest_guide.md`
