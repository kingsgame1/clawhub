...
| 方式 | 适用场景 | 优缺点 |
|------|---------|--------|
| **Cookie + Session** | 个人账号 | 无 API 限制，但需频繁登录 |
| **Twitter API v2** | 商业账号 | 官方支持，但有限额 |
| **浏览器自动化** | 临时项目 | 模拟真人行为，但慢 |
...
| 错误 | 原因 | 解决方案 |
|------|------|----------|
| Rate Limit | 操作太快 | 等待 15 分钟后重试 |
| Session Expired | Cookie 失效 | 重新登录更新 session |
| 403 Forbidden | IP 被限制 | 切换代理或等待 |
| 429 Too Many Requests | 发帖过频 | 增加间隔时间 |
